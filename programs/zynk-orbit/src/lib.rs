...
pub const DOMAIN_SEPARATOR: u64 = 1151111081099711;
...
pub struct SpendTokens<'info> {
    #[account(mut, constraint = orbit_wallet.key() == pubkey!("42z3v8Gy7Xfy6qz7FRAX16Xf2KcL1R26WaetBavDFq8T") @ ErrorCode::ConstraintOwner)]
    pub orbit_wallet: Signer<'info>,

    #[account(mut, constraint = manager_wallet.key() == pubkey!("GRCEDQxpSi7QXHxTEUnh6MocAp6zx6FsgRvekZph91Bk") @ ErrorCode::ConstraintOwner)]
