...
export async function deploy() {
  try {
    ...
    const programs = [
      { 
        programName: "zynk_core",
        programKeypairName: "ZynkcJyxiBTs9ePTQzHh7ckDDnwrLjuNVUbisF6hC7K" 
      }, { 
        programName: "zynk_orbit",
        programKeypairName: "Zynko1Dup7Cv2quEqLRuCs9Ds8vwELrWZk4eTLFXVCL" 
      }
      ]
      
    for (const _program of programs) {
      const { programKeypairName, programName } = _program
